...
{{--    <link rel="stylesheet" href="{{asset('css/adminmaster/style4.css')}}">--}}
    <!-- Bootstrap CSS CDN -->
    ...
    <!-- Font Awesome JS -->
    <script defer src="{{url('https://use.fontawesome.com/releases/v5.0.13/js/solid.js')}}" integrity="sha384-tzzSw1/Vo+0N5UhStP3bvwWPq+uvzCMfrN1fEFe+xBmv1C/AtVX5K0uZtmcHitFZ" crossorigin="anonymous"></script>
    <script defer src="{{url('https://use.fontawesome.com/releases/v5.0.13/js/fontawesome.js')}}" integrity="sha384-6OIrr52G08NpOFSZdxxz1xdNSndlD4vdcf/q2myIUVO0VsqaGHJsB0RaBE01VTOY" crossorigin="anonymous"></script>


    {{--    <link rel="stylesheet" href="{{asset('css/adminmaster/bootstrap.min.css')}}">--}}
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                        <a id="navbarDropdown" class="pul nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
